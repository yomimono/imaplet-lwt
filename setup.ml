...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1baf6b91421f20ce06a6665b030fc9c1) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build utilities";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build test";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_parent = Some "imaplet";
                      lib_findlib_name = Some "parsemail";
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "imaplet";
                      lib_findlib_name = Some "commands";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "imaplet";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "parse_restore";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "parse_restore.ml"});
               Executable
                 ({
                     cs_name = "dedup";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "dedup.ml"});
               Executable
                 ({
                     cs_name = "imaplet_configure";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "imaplet_configure.ml"
                   });
               Executable
                 ({
                     cs_name = "imaplet";
                      ...
                      bs_data_files =
                        [
                           ("../certificates/server.pem",
                             Some "$datadir/imaplet");
                           ("../certificates/server.key",
                             Some "$datadir/imaplet");
                           ("../config/imaplet.cf", Some "$datadir/imaplet");
                           ("../config/users", Some "$datadir/imaplet");
                           ("../deploy/imaplet.pl", Some "$datadir/imaplet");
                           ("../deploy/deploy.sh", Some "$datadir/imaplet");
                           ("../deploy/imapletd", Some "$datadir/imaplet")
                        ];
                      bs_findlib_extra_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "imaplet_server.ml"});
               Executable
                 ({
                     cs_name = "imaplet_create_account";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "imaplet_create_account.ml"
                   });
               Executable
                 ({
                     cs_name = "imaplet_deploy";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "imaplet_deploy.ml"});
               Executable
                 ({
                     cs_name = "imaplet_lmtp";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "imaplet_lmtp.ml"});
               Executable
                 ({
                     cs_name = "smtplet";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "smtplet.ml"});
               Executable
                 ({
                     cs_name = "imaplet_irmin_read";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "imaplet_irmin_read.ml"
                   });
               Executable
                 ({
                     cs_name = "imaplet_irmin_build";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "imaplet_irmin_build.ml"
                   });
               Executable
                 ({
                     cs_name = "imaplet_maildir_index";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "imaplet_maildir_index.ml"
                   });
               Executable
                 ({
                     cs_name = "imaplet_init_maildir";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "imaplet_init_maildir.ml"
                   });
               Executable
                 ({
                     cs_name = "get_messages";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "get_messages.ml"});
               Executable
                 ({
                     cs_name = "client";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "smtp_client.ml"});
               Executable
                 ({
                     cs_name = "test_gitl";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_gitl.ml"});
               Executable
                 ({
                     cs_name = "maildir_read";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "maildir_read.ml"});
               Executable
                 ({
                     cs_name = "irvsfsio";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "irvsfsio.ml"});
               Executable
                 ({
                     cs_name = "irvsfsio_cl";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "irvsfsio_cl.ml"});
               Executable
                 ({
                     cs_name = "email_server";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "email_server.ml"});
               Executable
                 ({
                     cs_name = "email_stats";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "email_stats.ml"});
               Executable
                 ({
                     cs_name = "stun";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "stun.ml"})
            ];
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "=fO\165Z\130\159}\140O\221\199\236?\174D";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
